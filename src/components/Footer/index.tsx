...
const Content = () => {
  const linkStyle =
    'justify-center text-foreground hover:text-destructive transition-colors flex items-center gap-2';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-3 gap-8 mb-8">
          ...
          <div className="self-center">
            <h3 className="font-theme text-2xl text-background text-center [writing-mode:vertical-lr] sm:[writing-mode:horizontal-tb]">
              JOZO
            </h3>
          </div>
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-center font-theme pt-2 pb-6 text-md text-background">
              Links
            </h4>
